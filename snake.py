...
#Setting all the images of the components in this project
...
def goti(a):
    l1=[[406,606],[456,606],[506,606],[556,606],[606,606],[656,606],[706,606],
    [756,606],[806,606],[856,606],[906,606],[906,560],[856,560],[806,560],[756,560],
    [706,560],[656,560],[606,560],[556,560],[506,560],[456,560],[456,506],[506,506],
    [556,506],[606,506],[656,506],[706,506],[756,506],[806,506],[856,506],[906,506],
    [906,460],[856,460],[806,460],[756,460],[706,460],[656,460],[606,460],[556,460],
    [506,460],[456,460],[456,406],[506,406],[556,406],[606,406],[656,406],[706,406],
    [756,406],[806,406],[856,406],[906,406],[906,360],[856,360],[806,360],[756,360],
    [706,360],[656,360],[606,360],[556,360],[506,360],[456,360],[456,306],[506,306],
    [556,306],[606,306],[656,306],[706,306],[756,306],[806,306],[856,306],[906,306],
    [906,260],[856,260],[806,260],[756,260],[706,260],[656,260],[606,260],[556,260],
    [506,260],[456,260],[456,260],[506,260],[556,260],[606,260],[656,260],[706,260],
    [756,206],[806,206],[856,206],[906,206],[906,160],[856,160],[806,160],[756,160],
    [756,160],[656,160],[606,160],[556,160],[506,160],[456,160]
    ]
...
def button2(text,xmouse,ymouse,x,y,w,h,i,a,fs):
    ...
    if x+w>xmouse>x and y+h>ymouse>y:
        pygame.draw.rect(GD,a,(x-2.5,y-2.5,w+h,h+5))
...
def options():
    ...
    while flag==True:
        ...
        b2=button("2 Player",mouse[0],mouse[1],(w/2-150),350,300,50,green,b_green,30,2)
        b3=button("3 Player",mouse[0],mouse[1],(w/2-150),450,300,50,green,b_green,30,3)
        b4=button("4 Player",mouse[0],mouse[1],(w/2-150),550,300,50,green,b_green,30,4)
...
def play(b):
    ...
    while True:
                ...
                if t==2:
                    ...
                    if p2score==100:
                        ...
                        while pygame.time.get_ticks()-time<2000:
                            ...
                            pygame.display.update()
                        break
        if 5>b>1: #yet to check for correctness
            if button1("Player 1",mouse[0],mouse[1],100,700,200,50,red,grey,30):
                if t==1:
                    p1score,l,s,six=turn(p1score,l,s)
                    xcr,ycr=goti(p1score)
        ...
        if 5>b>3:
            if button1("Player 4",mouse[0],mouse[1],1000,700,200,50,green,grey,30):
                if t==4:
        ...
        if l:
            time=pygame.time.get_ticks()
            while pygame.time.get_ticks()-time<2000:
                message_display1("There's a Laddeer!",650,50,35,black)
                pygame.display.update()
        if s:
            time=pygame.time.get_ticks()
            while pygame.time.get_ticks()-time<2000:
